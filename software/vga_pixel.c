...
#define AXIS_X1(x) ((x)+3)
#define AXIS_X2(x) ((x)+4)
#define AXIS_Y1(x) ((x)+5)
#define AXIS_Y2(x) ((x)+6)
...
{
        iowrite8(position->x1_axis, AXIS_X1(dev.virtbase) );	
        iowrite8(position->y1_axis, AXIS_Y1(dev.virtbase) );
	iowrite8(position->x2_axis, AXIS_X2(dev.virtbase) );
	iowrite8(position->y2_axis, AXIS_Y2(dev.virtbase) );
...
{
        vga_pixel_color_t beige = { 0x00, 0x00, 0x00 };
